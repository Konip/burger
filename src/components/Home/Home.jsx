            ...
            <section className="page-section app">
                <div className="container">
                    <div className="info width-half">
                        ...
                        <div className="text">Включите камеру на вашем телефоне и отсканируйте QR-код</div>
                    ...
                    <div className="app-image width-half">
                        <img src="https://blackstarburger.ru/wp-content/themes/tsumugi-child/img/app/hand.png" alt="" />
                    </div>
                </div>
            </section>
        </div>
